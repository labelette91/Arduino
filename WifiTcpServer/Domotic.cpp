...
void reportDomoticTemp ( int temp , byte id1 , byte id2 ){
    ...
    serverClients.write((byte*)&Send.Temp,9);
}
...
//	if (AsSensorValueChanged(temp,id1))
  ...
  serverClients.write((byte*)&Send.Temp_Hum,sizeof(Send.Temp_Hum));
	}
...
tlong.Long= getTotalPower(data);
  ...
  serverClients.write((byte*)&Send.Temp_Hum,sizeof(Send.ENERGY));
...
void DomoticStartReceive()
{
  ...
  serverClients.write((byte*)&Send.IRESPONSE,sizeof(Send.IRESPONSE));
...
void reportHagerDomoticUnk ( const byte* data, byte pos ){
  ...
  serverClients.write((byte*)&Send.UNDECODED,Send.UNDECODED.packetlength+1  );
}
...
//devbug
  ...
  serverClients.write((byte*)&Send.LIGHTING2,Send.LIGHTING2.packetlength+1  );
}
